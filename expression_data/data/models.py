...
class GeneExperimentData(BaseData):                
    ...
    amount_1 = models.DecimalField(max_digits=10, decimal_places=6, blank=True, null=True, help_text="The amount in the first group.")
    amount_2 = models.DecimalField(max_digits=10, decimal_places=6, blank=True, null=True, help_text="The amount in the second group.")
    ...
    test_statistic = models.DecimalField(max_digits=6, decimal_places=5, blank=True, null=True, help_text="The value of the test statistic used to compute significance.")
